...
本项目的英文键来自本机已安装的 n8n 2.33.7 发行包，包括官方 `@n8n/i18n` 英文资源、`n8n-nodes-base` 与 `@n8n/n8n-nodes-langchain` 的可见节点定义。中文由本项目独立翻译并按本机版本校验。
...
当前 n8n 2.33.7 的节点覆盖审计为 27,818/27,818；安装器生成 563 个节点翻译文件、48,919 个原生翻译落点。该口径排除代码、表达式、用户数据、品牌名和应保持原样的纯技术标记，并非对未来版本或任意社区节点的永久覆盖承诺。
